  ...
  return (
    <div className="min-h-screen bg-background flex">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Badge variant="outline">
                    {viewingClinica.qntd_dentistas || 0} dentistas
                  </Badge>
                </div>
                <div>
                  <Label className="text-sm font-medium text-muted-foreground">Pacientes</Label>
                  <Badge variant="outline">
                    {viewingClinica.qntd_pacientes || 0} pacientes
                  </Badge>
                </div>
              </div>
            </div>
      ...
      <Dialog open={adminDialogOpen} onOpenChange={setAdminDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Criar Admin de Filial</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                onClick={() => {
                  if (adminTargetClinica) {
                    createAdminClinica.mutate({
                      clinicaId: adminTargetClinica.id,
                      name: adminName,
                      email: adminEmail,
                ...
                disabled={!adminName || !adminEmail || !adminPassword || createAdminClinica.isPending}
              >
                Criar Admin
              </Button>
            </div>
