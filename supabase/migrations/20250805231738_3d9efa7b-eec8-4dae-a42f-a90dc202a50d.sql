...
CREATE TRIGGER update_tipos_protese_updated_at BEFORE UPDATE ON public.tipos_protese FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_cores_updated_at BEFORE UPDATE ON public.cores FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
CREATE TRIGGER update_compatibilidade_updated_at BEFORE UPDATE ON public.compatibilidade_produto_material_cor FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
-- Create indexes
CREATE INDEX idx_products_categoria_new ON public.products(categoria);
CREATE INDEX idx_products_ativo_new ON public.products(ativo);
